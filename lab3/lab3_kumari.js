...
// print numbers from 9 to 0 --> 3,2,1,0
for(let x = 3; x >= 0; x-- ){
    console.log(x)
}
...
for(let counter = 1; counter <= 3 ; counter++){
    let user_number = parseInt(prompt("Enter a numebr between 1 and 9"))
...
while(true){
    console.log(`Press Any another number for Exit`)
